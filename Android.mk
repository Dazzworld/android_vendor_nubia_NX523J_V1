...
include $(CLEAR_VARS)
LOCAL_MODULE := FingerPrintsUI
LOCAL_MODULE_OWNER := nubia
LOCAL_SRC_FILES := proprietary/app/FingerPrintsUI/FingerPrintsUI.apk
...
include $(CLEAR_VARS)
LOCAL_MODULE := FpService
LOCAL_MODULE_OWNER := nubia
LOCAL_SRC_FILES := proprietary/app/FpService/FpService.apk
LOCAL_CERTIFICATE := platform
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_CLASS := APPS
LOCAL_MODULE_SUFFIX := .apk
...
LOCAL_MODULE_OWNER := nubia
LOCAL_SRC_FILES := proprietary/app/QComQMIPermissions/QComQMIPermissions.apk
LOCAL_CERTIFICATE := platform
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_CLASS := APPS
LOCAL_MODULE_SUFFIX := .apk
...
LOCAL_MODULE_OWNER := nubia
LOCAL_SRC_FILES := proprietary/app/QtiDdsSwitchService/QtiDdsSwitchService.apk
LOCAL_CERTIFICATE := platform
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_CLASS := APPS
LOCAL_MODULE_SUFFIX := .apk
...
include $(CLEAR_VARS)
LOCAL_MODULE := goodix_fingerprintmanager
LOCAL_MODULE_OWNER := nubia
LOCAL_SRC_FILES := proprietary/framework/goodix_fingerprintmanager.jar
LOCAL_CERTIFICATE := platform
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_CLASS := JAVA_LIBRARIES
LOCAL_MODULE_SUFFIX := .jar
